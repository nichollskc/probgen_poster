...
%\caption{Clustering error (CE) across all simulated datasets. Larger values indicate higher accuracy. $K=5$. Thresholding has been applied. Runs that failed are discarded in the analysis.}
\end{figure}
