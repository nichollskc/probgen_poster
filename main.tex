...
\title{Biclustering using sparse factor analysis to understand the human immune system} % Poster title
...
\subfloat[Original matrix \label{fig:raw}]{
    \includegraphics[width=0.25\textwidth]{biclustering_diagrams/light_blue/raw.png}}
\subfloat[Clustering rows \label{fig:rows}]{
    \includegraphics[width=0.25\textwidth]{biclustering_diagrams/light_blue/rows.png}}
\subfloat[Clustering columns \label{fig:cols}]{
    \includegraphics[width=0.25\textwidth]{biclustering_diagrams/light_blue/cols.png}}
\end{minipage}
\begin{minipage}{1\linewidth}
    \centering
\subfloat[Sum of biclusters \label{fig:biclusters}]{
    \includegraphics[width=0.8\textwidth]{biclustering_diagrams/light_blue/sum.png}}    
\end{minipage}
...
\begin{figure}[h]
\centering
\includegraphics[scale=0.85]{sample_heatmap.png} 
